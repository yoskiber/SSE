            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php $query = $connection->query("SELECT * FROM pengguna"); while ($row = $query->fetch_assoc()):
                        $role = $row['status']; 
                    endwhile;?> 
                            <li></li>
                         <?php if ($Role == 'petugas') : ?>
                            <li class="dropdown">
                          <a href="#" class="dropdown-toggle" style="font-weight: bold; color: green;" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Laporan Per Beasiswa <span class="caret"></span></a>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="?page=pendaftaran">Data siswa</a></li>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li><a href="?page=lap_permahasiswa">Per siswa</a></li>
            ...
            <?php elseif ($Role == 'siswa') : ?>
                 <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                             <li><a href="?page=pendaftaran">Data siswa</a></li>
                              <li class="divider"></li>
                            <li><a href="?page=nilai siswa">daftar beasiswa</a></li>
                          </ul>
                </li>
